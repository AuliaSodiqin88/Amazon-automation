...
class SignUp {
	...
	def navigateToSignUpPage() {
		println ("\n User signUp navigateToSignUpPage")
	}

	@When("User enters name and email and password and re-password")
	def entersCredentials() {
		println ("\n User signUp entersCredentials")
	}

	@And("User click create account button")
	def clickCreatebutton() {
		println ("\n User signUp clickCreatebutton")
	}

	@And("User input otp")
	def inputOTP() {
		println ("\n User signUp inputOTP")
	}

	@And("User click continue")
	def clickContinue() {
		println ("\n User signUp clickContinue")
	}

	@And("User input phone number")
	def inputPhonenumber() {
		println ("\n User signUp inputPhonenumber")
	}

	@And("User click continue")
	def clickNext() {
		println ("\n User signUp clickNext")
	}

	@Then("User is navigate to homepage")
	def VerifyHomePage() {
		println ("\n User SignUp VerifyHomePage")
	}
}